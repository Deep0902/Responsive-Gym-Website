    ...
    <body>
        ...
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <ul class="nav__list">
                        <li class="nav__item">
                          <a href="/responsive-gym-website-main/index.php" class="nav__link">Home</a>
                        </li>
                        <li class="nav__item">
                            <a href="/responsive-gym-website-main/aboutus.php" class="nav__link">About Us</a>
                          </li>
                          <li class="nav__item">
                            <a href="/responsive-gym-website-main/contactus.php" class="nav__link active-link">Contact Us</a>
                          </li>
                          


                          <div class="nav__link" >
                            <a href="/responsive-gym-website-main/registernow.php" target="_blank" class="nav__link">
                              Register Now
                            </a>
                          </div>
                    </ul>
        ...
        <footer class="footer section" id="footer">
          <div class="footer__container container grid">
            <div>
              ...
              <br>
              <a href="https://goo.gl/maps/Cm7RMfs2UbfoGiUKA" target="_blank" class="button button__flex">
                Get Directions
              </a>
